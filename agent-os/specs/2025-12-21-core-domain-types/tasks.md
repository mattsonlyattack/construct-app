...
- [x] 1.0 Complete infrastructure layer
  ...
  - [x] 1.3 Update `INITIAL_SCHEMA` in `src/db/schema.rs`
...
- [x] 2.0 Complete TagSource and Tag types
  - [x] 2.1 Write 4 focused tests for TagSource and Tag
  ...
  - [x] 2.2 Create `src/models/mod.rs` module file
  ...
  - [x] 2.3 Implement `TagSource` enum in `src/models/tag_source.rs`
    - Variants: `User`, `Llm`
  ...
  - [x] 2.4 Implement `Tag` struct in `src/models/tag.rs`
  ...
  - [x] 2.5 Update `src/lib.rs` to expose models module
    - Add `pub mod models;`
    - Add `pub use models::{Tag, TagSource};` (Note and TagAssignment added later)
  - [x] 2.6 Ensure TagSource and Tag tests pass
...
- [x] 3.0 Complete TagAssignment and Note types
  - [x] 3.1 Write 5 focused tests for TagAssignment and Note
  ...
  - [x] 3.2 Implement `TagAssignment` struct in `src/models/tag_assignment.rs`
