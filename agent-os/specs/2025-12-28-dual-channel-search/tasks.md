...
- [ ] 1.0 Complete configuration and data structures
  - [ ] 1.1 Write 3 focused tests for DualSearchConfig and new structs
  ...
  - [ ] 1.2 Create DualSearchConfig struct in `src/service.rs`
  ...
  - [ ] 1.3 Create DualSearchResult struct in `src/service.rs`
  ...
  - [ ] 1.4 Create DualSearchMetadata struct in `src/service.rs`
...
- [ ] 2.0 Complete dual_search method implementation
  - [ ] 2.1 Write 5 focused tests for dual_search method
  ...
  - [ ] 2.2 Implement dual_search method in NoteService
  ...
  - [ ] 2.3 Implement cold-start detection logic
  ...
  - [ ] 2.4 Implement result merging and scoring
...
- [ ] 3.0 Complete CLI integration
  - [ ] 3.1 Write 3 focused tests for CLI search behavior
  ...
  - [ ] 3.2 Modify execute_search in `src/main.rs` to use dual_search
  ...
  - [ ] 3.3 Update search result display format
  ...
  - [ ] 3.4 Add graph skip notice to output
  ...
  - [ ] 3.5 Ensure Task Group 3 tests pass
...
- [ ] 4.0 Review existing tests and fill critical gaps only
  - [ ] 4.1 Review tests from Task Groups 1-3
    ...
    - Review the 3 tests written in Task Group 3 (CLI integration)
    - Total existing tests: 11 tests
  - [ ] 4.2 Analyze test coverage gaps for dual-channel search feature only
    - Identify critical user workflows that lack test coverage
    - Focus ONLY on gaps related to this spec's feature requirements
    - Do NOT assess entire application test coverage
    - Prioritize end-to-end workflows over unit test gaps
  - [ ] 4.3 Write up to 7 additional strategic tests maximum
    - Consider integration test: dual_search with populated database returns expected rankings
    - Consider edge case: all notes found by both channels (max intersection bonus)
    - Consider edge case: no notes found at all (empty result handling)
    - Consider config test: custom weights affect final_score calculation
    - Skip exhaustive edge case testing (deferred per testing standards)
